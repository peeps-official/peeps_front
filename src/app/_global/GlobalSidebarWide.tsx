...
export default function GlobalSidebarLeft() {
  ...
  return (
    <div className={"fixed flex flex-col items-start h-screen w-64 text-left bg-white text-mini text-dimgray-100 font-kr overflow-y-hidden hover:overflow-y-auto"}>
      {/* 본인 프로필 및 닉네임 */}
      <Link
      ...
      >
        <div className="flex items-center gap-[16px]">
          ...
          <div className="flex flex-col justify-center">
            <b className="relative leading-[16px] font-bold inline-block">
      ...
      <div className="flex items-center py-0 px-[15px]">
        <div className="h-[1px] w-48 relative bg-gray-10" />
      </div>
